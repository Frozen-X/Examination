				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
                           ...
                           <button class="btn btn-default btn-danger col-md-1 btn-info col-md-offset-3" style="margin-top: 20px" onClick="location.href='${pageContext.request.contextPath}/teacher/statistic?id=${id}&type=1'">统计成绩</button>
                        </div>
				    </div>
								...
								<c:forEach items="${selectedCourseList}" var="item">
									<tr>
										...
										<c:if test="${item.over}">
											<td>${item.mark}</td>
											<td>
												<button class="btn btn-default btn-xs btn-info" onClick="location.href='${pageContext.request.contextPath}/teacher/mark?studentid=${item.studentid}&courseid=${item.courseid}'">重新打分</button>
											</td>
										</c:if>
									</tr>
								</c:forEach>
